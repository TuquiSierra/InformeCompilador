...
Para resolver la sintáctica del compilador se utilizó el módulo de Python \textbf{PLY}. \textbf{PLY} es una implementación pura de Python de las populares herramientas de construcción de compiladores \textit{lex} y \textit{yacc}, generando el primer \textbf{AST} del proceso de compilación.

\subsection{Tokenización con \textit{lex}}
